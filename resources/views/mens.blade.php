	...
	<div class="container">
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men1.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{url('/')}}/asset/images/men3.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{url('/')}}/asset/images/a2.png" alt="" class="pro-image-front">
							<img src="{{url('/')}}/asset/images/a2.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{url('/')}}/asset/images/a8.png" alt="" class="pro-image-front">
						<img src="{{url('/')}}/asset/images/a8.png" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{url('/')}}/asset/images/mw1.png" alt="" class="pro-image-front">
						<img src="{{url('/')}}/asset/images/mw1.png" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{url('/')}}/asset/images/mw3.png" alt="" class="pro-image-front">
						<img src="{{url('/')}}/asset/images/mw3.png" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
