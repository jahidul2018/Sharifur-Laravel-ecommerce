...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{url('/')}}/city/update/{{$cities->id}}">
                {{ csrf_field() }}
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">City Name </label>

                    <div class="col-sm-9">
                        <input type="text" id="form-field-1" value="{{$cities->name}}" name="name" class="col-xs-10 col-sm-5" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="countriesid">
                            ...
                            @if($cities->countriesid == $country->id)
