...
<html lang="en">
    <head>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="{{url('/')}}/backEnd/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
        <![endif]-->
        <link rel="stylesheet" href="{{url('/')}}/backEnd/assets/css/ace-skins.min.css" />
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="{{url('/')}}/backEnd/assets/images/avatars/user.jpg" alt="Jason's Photo" />
            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="">
                        <a href="{{url('/')}}/unit/add">
                            <i class="menu-icon fa fa-cog"></i>
                            <span class="menu-text"> Unit Manage</span>
                        </a>
                    ...
                    <li class="">
                        <a href="{{url('/')}}/size/add">
                            <i class="menu-icon fa fa-cog"></i>
                            <span class="menu-text"> Size Manage</span>
                        </a>

                        <b class="arrow"></b>
                    </li>
                    <li class="">
                        <a href="{{url('/')}}/country/add">
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement)
        document.write("<script src='{{url('/')}}/backEnd/assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
</script>
...
<![endif]-->
<script src="{{url('/')}}/backEnd/assets/js/jquery-ui.custom.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.ui.touch-punch.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.easypiechart.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.sparkline.index.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.flot.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.flot.pie.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->
<script src="{{url('/')}}/backEnd/assets/js/ace-elements.min.js"></script>
<script src="{{url('/')}}/backEnd/assets/js/ace.min.js"></script>
