	...
	<div class="container">
					...
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethinic Wear</label>
								<ul>
									<li><a href="{{url('/')}}/womens">Sarees</a></li>
									<li><a href="{{url('/')}}/womens">Chudidars</a></li>
									<li><a href="{{url('/')}}/womens">Wedges</a></li>
									<li><a href="{{url('/')}}/womens">Tops</a></li>
									<li><a href="{{url('/')}}/womens">Perfumes</a></li>
									<li><a href="{{url('/')}}/womens">Caps</a></li>
								</ul>
							</li>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men21.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men11.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{url('/')}}/asset/images/men21.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{url('/')}}/asset/images/men31.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{url('/')}}/asset/images/a1.png" alt="" class="pro-image-front">
							<img src="{{url('/')}}/asset/images/a1.png" alt="" class="pro-image-back">
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{url('/')}}/asset/images/w1.png" alt="" class="pro-image-front">
							<img src="{{url('/')}}/asset/images/w1.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{url('/')}}/asset/images/w2.png" alt="" class="pro-image-front">
						<img src="{{url('/')}}/asset/images/w2.png" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{url('/')}}/asset/images/a5.png" alt="" class="pro-image-front">
						<img src="{{url('/')}}/asset/images/a5.png" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
			...
			<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{url('/')}}/asset/images/a6.png" alt="" class="pro-image-front">
									<img src="{{url('/')}}/asset/images/a6.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
			...
			<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{url('/')}}/asset/images/a7.png" alt="" class="pro-image-front">
									<img src="{{url('/')}}/asset/images/a7.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
			...
			<div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{url('/')}}/asset/images/a3.png" alt="" class="pro-image-front">
									<img src="{{url('/')}}/asset/images/a3.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
